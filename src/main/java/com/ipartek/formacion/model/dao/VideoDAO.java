...
public class VideoDAO {
	...
	public ArrayList<Video> getAll() {
		...
		String sqlCreate = "SELECT `id`, `nombre`, `codigo` FROM `video` ORDER BY `id` DESC ";
		/*
		 * String sqlDelete = "DELETE FROM `video` where id =`id` "; String sqlModify =
		 * "UPDATE video SET nombre=`nombre` WHERE id=`id`; ";
		 */
