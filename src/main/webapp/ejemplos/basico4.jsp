...
<h1>Ejemplo Servlet GET y POST</h1>
	...
	<h2>Ejemplo GET</h2>
	<p>Este método solicita una representación del recurso especificado. Solo deben recuperar datos y no deben tener ningún otro efecto. Sirven para solicitar datos al servidor.</p>
